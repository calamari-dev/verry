...
class flatiter[T: SignedComparable](Iterator[Interval[T]]):
...
def resolve_intervalmatrix[T: SignedComparable](
...
class IntervalMatrix[S: SignedComparable](ABC):
    ...
    def __matmul__(self, rhs: Self | npt.NDArray) -> Self | Interval[S]:
    ...
    def __rmatmul__(self, lhs: Self | npt.NDArray) -> Self | Interval[S]:
